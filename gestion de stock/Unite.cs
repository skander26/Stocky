    ...
    public partial class Unite : Form
    {
        ...
        private void insert()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    string query = "INSERT INTO unite ( designation) VALUES ( @design)";
        ...
        private void CellClick(object sender, GridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 3)
            {
                ...
                string query = "delete from unite where id = @Id";
                bool sup = showpopup();
                if (sup)
                {
        ...
        private void Updated(string id)
        {
            ...
            try
            {
                ...
                string query = "UPDATE unite SET designation = @desg WHERE id = @id";
                SqlCommand cmd = new SqlCommand(query, baseD.cnn);
